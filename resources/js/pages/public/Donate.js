...
function Donate({ dispatch, page }) {
  ...
  useEffect(() => {
    dispatch(actions.AUX.updatePageTitle({ pageTitle: `Donate`, showCurrent: true }))
  }, [])
  ...
  return (
    <React.Fragment>
      <div className="feature-coming-soon-page">
        ...
        <p>
          Please consider donating in one of the above mentioned methods. All funds will go towards
          the time it takes to develop features, and platform/server maintainence.
        </p>
        <p>
          If a surplus of donations are received the net surplus will be directed towards some form
          of relief for those impacted.
        </p>
      </div>
      <form
        className="donate-pp"
