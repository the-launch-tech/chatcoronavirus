...
function Search({ title, page, dispatch, loading }) {
  ...
  useEffect(() => {
    dispatch(
      actions.AUX.updatePageTitle({ pageTitle: `Search ChatCoronavirus`, showCurrent: true })
    )
  }, [])
    ...
    <React.Fragment>
      <div className="searchform-wrapper">
        <div className="searchform">
          ...
          <button className="toggle-advanced-search md-btn blue-btn" onClick={toggleAdvancedSearch}>
